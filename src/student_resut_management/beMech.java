 ...
 * @author HANIFA
 */
public class beMech extends javax.swing.JFrame {

    /**
     * Creates new form beMech
     */
    public beMech() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MECHANICAL ENGINEERING");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from students where RollNumber = '"+rollno+"' and branch = 'MECH'");
            if(rs.next()){
                st.executeUpdate("insert into beMech values ('"+rollno+"',"+m1+","+m2+","+m3+","+m4+","+m5+","+m6+")");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beMech.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
