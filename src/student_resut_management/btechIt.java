...
public class btechIt extends javax.swing.JFrame {

    /**
     * Creates new form btechIt
     */
    public btechIt() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from students where RollNumber = '"+rollno+"' and branch = 'IT'");
            if(rs.next()){
                st.executeUpdate("insert into btechIt values ('"+rollno+"',"+m1+","+m2+","+m3+","+m4+","+m5+","+m6+")");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(btechIt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
