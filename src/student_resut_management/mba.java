...
public class mba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MASTER OF BUSINESS ADMINISTRATION");
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addComponent(Logout2, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from students where RollNumber = '"+rollno+"' and courseName = 'MBA'");
            if(rs.next()){
                st.executeUpdate("insert into mba values ('"+rollno+"',"+m1+","+m2+","+m3+","+m4+","+m5+","+m6+")");
